...
echo '<div class="col-lg-3 col-md-8 justify-content-end col-6 text-white d-flex align-items-center">';

// echo '<small>Call Now</small><br>';

// echo '<div class="d-flex align-items-center justify-content-end">';

echo do_shortcode('[button href="' . get_permalink(1723) . '" class="" title="phone number link for Mark McFarland, P.E. - Expert Witness & Forensic Engineering" style="font-size:12px;" class="d-md-block d-none"]Speak with an Expert[/button]');

echo do_shortcode('[button href="' . get_permalink(1723) . '" class="" title="phone number link for Mark McFarland, P.E. - Expert Witness & Forensic Engineering" style="font-size:10px;margin-right:15px;padding:5px;white-space: nowrap;" class="desktop-hidden"]Speak with an Expert[/button]');
...
// echo '<div class="col-12 text-right desktop-hidden">';
// echo do_shortcode('[button href="tel:+1' . globalPhone() . '" class="" title="phone number link for Mark McFarland, P.E. - Expert Witness & Forensic Engineering" style="font-size:10px;margin-right:0px;padding:5px;" class=""]Speak with an Expert[/button]');
// echo '</div>';
