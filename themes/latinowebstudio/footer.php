...
echo '<div style="width:100%;max-width:205px;" id="logoMain">';
echo '<a href="' . home_url() . '" title="Homepage link for Mark McFarland, P.E. - Expert Witness & Forensic Engineering">';
...
echo do_shortcode('[button href="' . get_permalink(1723) . '" style="margin-left:0;" title="phone number link for Mark McFarland, P.E. - Expert Witness & Forensic Engineering"]Speak with an Expert[/button]');
